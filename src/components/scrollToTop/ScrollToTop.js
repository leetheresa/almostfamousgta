            ...
            {showTopBtn && (
                <button id="afg-scrollTop" className="afg-scrollTop" type="button" onClick={goToTop}>
                    <svg focusable="false" xmlns="http://www.w3.org/2000/svg" width="8.408" height="13.988" viewBox="0 0 8.408 13.988">
                        <path data-name="Path 1157" d="M419.654,212.032l-6.287,6.287-6.287-6.287" transform="translate(-211.325 420.361) rotate(-90)" fill="none" stroke="#111" stroke-miterlimit="10" stroke-width="3"></path>
                    </svg>
                </button>
            )}{" "}
        </>
